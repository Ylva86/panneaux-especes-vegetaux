...
function resizeComponents(){if(global.printBody)printBody.onResize();if(global.downLoadBody)downLoadBody.onResize();if(global.helpBody)helpBody.onResize();if(global.aboutBody)aboutBody.onResize();if(global.sharePanel)sharePanel.onResize();if(global.languagePanel)languagePanel.onResize();if(global.frmTableOfContent)frmTableOfContent.onResize();if(global.bookmark)bookmark.onResize();if(bookConfig.AnnotationButtonVisible&&global.annotationPannel)global.annotationPannel.onResize()};var PcAboutForm=Class({create:function(a){this._super(a)},onCreate:function(){this._super();this.bookReadTimesVisible()},initColorCss:function(){this.stage.css({"background-color":this.mainColor,color:this.fontColor,border:"1px solid"+Color(this.mainColor).add(50),"box-shadow":"0 0 5px"+this.mainColor});this.stage.find(".focus").css("border","1px solid "+this.fontColor)},initHtml:function(){this.stage.addClass("win10_border");this.stage.append(this.title);this.favicon&&(bookConfig.RightToLeft?this.title.append(this.favicon):
this.title.prepend(this.favicon));this.stage.append(this.close);if(bookConfig.CompanyLogoFile||bookConfig.AboutDescription)this.stage.append(this.descriptionTitle),this.stage.append(this.contactTitle);this.content1=$("<div class='content content1'></div>");this.stage.append(this.content1);this.content1.append(this.author);this.content1.append(this.address);this.content1.append(this.email);this.content1.append(this.website);this.content1.append(this.mobile);this.content2=$("<div class='content content2 stage'></div>");
this.swiper=$("<div class='swiper'></div>");this.progress=$("<div class='progress'></div>");this.progressBar=$("<div class='progressBar'></div>");this.progress.append(this.progressBar);this.content2.append(this.progress);this.stage.append(this.content2);this.content2.append(this.swiper);bookConfig.CompanyLogoFile&&this.swiper.append(this.logo);this.swiper.append(this.description);this.content2.scroll({},Direction.top,"win10");this._super()},bookReadTimesVisible:function(){var a=setInterval(function(){try{this.ReadTimes=
global.aboutReadTimes?global.aboutReadTimes:0,0<this.ReadTimes?(this.content1.append(this.views),clearInterval(a)):10<this.elements.iRead&&clearInterval(a)}catch(b){}}.bind(this),1E3)},showContact:function(){this.descriptionTitle.removeClass("focus");this.contactTitle.addClass("focus");this.descriptionTitle.css("border","1px solid transparent");this.contactTitle.css("border","1px solid "+this.fontColor);this.content1.show();this.content2.hide()},showDescription:function(){this.contactTitle.removeClass("focus");
...
this.content=$("<div class='bookmark_content'></div>");this.stage.append(this.content);var a=$("<p class='inputForm'></p>");a.append(this.input);a.append(this.colorSelection);this.content.append(a);this.content.append(this.leftAddPage);this.content.append(this.rightAddPage);this.content.append(this.bookmarkListTitle);this.content.append(this.bookmarkListPanel.bookmarkSwiper);this.content.append(this.remove);this.parent.append(this.stage);this.refreshPanel()},onResize:function(){var a=Math.max(windowHeight-
bookConfig.topMargin-bookConfig.bottomMargin-toolBar.getHeight(),1);toolBar.getWidth();this.stage.find(".bookmark_content").css({height:a-87+"px"});var b=toolBar.getTopHeight()+10;this.width=240;this.height=a-40;this.maxHeight=this.height-188;this.stage.css({height:this.height+"px",top:b+"px"});this.bookmarkListPanel.onResize(this.width,this.maxHeight);this.refreshPanel()}}).extend(PcBookmarkFrame);var PcHelpForm=Class({create:function(a){this._super(a)},onCreate:function(){this._super()},initColorCss:function(){this.stage.css({"background-color":this.mainColor,color:this.fontColor,border:"1px solid"+Color(this.mainColor).add(50),"box-shadow":"0 0 5px"+this.mainColor})},initHtml:function(){this.stage.addClass("win10_border");this.stage.append(this.title);this.favicon&&(bookConfig.RightToLeft?this.title.append(this.favicon):this.title.prepend(this.favicon));this.stage.append(this.close);this.stage.append(this.image);
this.title1&&this.stage.append(this.title1);this.title2&&this.stage.append(this.title2);this._super()}}).extend(PcHelpFrame);var PcPrintForm=Class({create:function(a){this._super(a)},onCreate:function(){this._super()},initColorCss:function(){this.stage.css({"background-color":this.mainColorObj.rgba(this.formOpacity),color:this.fontColor,border:"1px solid"+Color(this.mainColor).add(50),"box-shadow":"0 0 5px"+this.mainColor})},initHtml:function(){this.stage.addClass("win10_border");this.stage.append(this.title);this.favicon&&(bookConfig.RightToLeft?this.title.append(this.favicon):this.title.prepend(this.favicon));this.stage.append(this.close);
this.stage.append(this.printAll);this.stage.append(this.printCurrent);this.stage.append(this.printRange);this.stage.append(this.printButton);this._super()}}).extend(PcPrintFrame);var PcTableOfContentItem=Class({create:function(a,b,c){b.fontColor=bookConfig.formFontColor?bookConfig.formFontColor:bookConfig.iconColor;this._super(a,b,c)}}).extend(TableOfContentItem);var PcTableOfContentForm=Class({create:function(a){this._super(a)},onResize:function(){var a=Math.max(windowHeight-bookConfig.topMargin-bookConfig.bottomMargin-toolBar.getHeight(),1);toolBar.getWidth();var b=toolBar.getTopHeight()+10;this.width=250;this.height=a-40;this.maxHeight=this.height-75;this.stage.css({height:this.height+"px",top:b+"px"});this.tableofcontentSwiper.css("height",this.maxHeight+"px");this.elements.refresh()}}).extend(PcTableOfContentFrame);var PcVideoGalleryForm=Class({create:function(a){this._super(a)},onCreate:function(){this._super()},initColorCss:function(){this.stage.css({"background-color":this.mainColor,color:this.fontColor,border:"1px solid"+Color(this.mainColor).add(50),"box-shadow":"0 0 5px"+this.mainColor})},initHtml:function(){this.stage.addClass("win10_border");this.stage.append(this.title);this.favicon&&(bookConfig.RightToLeft?this.title.append(this.favicon):this.title.prepend(this.favicon));this.stage.append(this.close);
this.stage.append(this.video);this.stage.append(this.info);if(this.videoList&&1<this.videoList.length){var a=$("<div class='video_list'></div>");a.append(this.videoListTitle);a.append(this.videoSwiper);this.stage.append(a)}else this.stage.css("width","335px");this._super()}}).extend(PcVideoGalleryFrame);var PcShareForm=Class({create:function(a){this._super(a)},onCreate:function(){bookConfig.addCurrentPage&&this.content.css({height:"215px"});this._super()},initColorCss:function(){this.stage.css({"background-color":this.mainColorObj.rgba(this.formOpacity),color:this.fontColor,border:"1px solid"+Color(this.mainColor).add(50),"box-shadow":"0 0 5px"+this.mainColor})},initSwiper:function(){this.swiperContainer=$("<div class='swiperContainer'></div>");this.shareStage=$("<div class='shareStage stage'></div>");
...
this.favicon&&(bookConfig.RightToLeft?this.title.append(this.favicon):this.title.prepend(this.favicon));this.stage.append(this.close);this.content=$("<div class='share_content'></div>");this.initSwiper();this.stage.append(this.content);this.shareCurrentPageBox.append(this.shareCurrentCheck).append(this.shareCurrentPageTitle1);this.getQrCodeVisible&&this.content.append(this.codeBox);this.swiperContainer.append(this.sharePanelTitle);this.content.append(this.swiperContainer);this.linkBox.append(this.linkArea).append(this.copy1);
this.content.append(this.shareCurrentPageBox);this.content.append(this.linkBox);this._super()}}).extend(PcShareFrame);var PcDownloadForm=Class({create:function(a){this._super(a)},onCreate:function(){this._super()},resetColorChanged:function(){this._super();this.dragIcon[0].colorChanged=!1},resetIconSrc:function(){this._super();this.dragIcon.attr("src",this.dragUrl)},changeIconColor:function(){this._super();this.dragIcon.changeButtonColor(this.fontColor);this.changeItemColor()},changeItemColor:function(){this.downloadCurrent.changeButtonColor(this.fontColor);this.downloadAttachments.changeButtonColor(this.fontColor);
