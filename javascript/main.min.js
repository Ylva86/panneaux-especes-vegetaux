...
b=1;b<this.cells.length;b++)a=a+"-"+getShownPageNumber(this.cells[b].index);this.title=$("<p class='title'>"+a+"</p>");this.title.css({background:Color(bookConfig.formBackgroundColor).rgba(.6)})},addItem:function(){for(var a=this.cells.length,b=0;b<a;b++)this.item.append(this.cells[b].getDom())},fillContent:function(){for(var a=this.cells.length,b=0;b<a;b++)this.cells[b].fillContent(0)},initCells:function(){for(var a=0;a<this.pages.length;a++){var b=new ThumbnailCell(this.item,this.pages[a]);this.cells.push(b)}},
setPosition:function(a,b){this.item.css(b,a+"px")},fission:function(){this.item.removeClass("focus");1==this.cells.length?(BookInfo.isLeftPage(this.cells[0].index,!0)?this.cells[0].setStyle({left:"-3px",right:"auto"}):this.cells[0].setStyle({right:"-3px",left:"auto"}),this.cells[0].fission()):(this.cells[0].fission(),this.cells[1].fission(),this.cells[0].setStyle({left:"-3px",right:"auto"}),this.cells[1].setStyle({right:"-3px",left:"auto"}),this.cells[0].removeClass("left"),this.cells[1].removeClass("right"))},
merge:function(){1==this.cells.length?this.cells[0]&&this.cells[0].setStyle({left:"0",right:"0"}):(this.item.addClass("focus"),this.cells[0].merge(),this.cells[1].merge(),this.cells[0].setStyle({left:"0",right:"auto"}),this.cells[1].setStyle({right:"0",left:"auto"}),this.cells[0].addClass("left"),this.cells[1].addClass("right"))},setHighLight:function(a){for(var b=0;b<this.cells.length;b++)this.cells[b].setHighLight(a);this.item.addClass("highlight")},clearHighLight:function(){this.item.removeClass("highlight");
for(var a=0;a<this.cells.length;a++)this.cells[a].clearHighLight()}});var ThumbnailFrame=Class({create:function(a){this._super(a);this.direction=rightToLeft?Direction.right:Direction.left;this.leftButtonUrl=uiBaseURL+"left.png";this.rightButtonUrl=uiBaseURL+"right.png";this.itemArray=[];this.taskList=new TaskList;this.initDefaultDom();this.initHtml();this.initEvent();this.onResize();this.initCss();this.hide()},initHtml:virtual_function,initCss:function(){rightToLeft&&this.stage.addClass("rightToLeft");this.initColorCss()},initColorCss:function(){this.stage.css({"background-color":this.mainColorObj.rgba(.6),
color:this.fontColor})},initDefaultDom:function(){this.closeUrl=form_icons.close?"data:image/png;base64,"+form_icons.close:uiBaseURL+"close.png";this.close=$("<img alt='close' width='auto' height='auto' class='close' src='"+this.closeUrl+"' />");this.close.click(this.hide.bind(this));this.close.changeButtonColor(this.fontColor);this.initSwiper()},initSwiper:function(){this.thumbnailSwiper=$("<div class='thumbnailSwiper stage'></div>");this.thumbnailSwiperList=$("<div class='swiper'></div>");this.progress=
...
magnifier:"",
...
previous_normal:"",
previous_normal_down:"",
next_normal_down:"",
next_normal:""};Class("ButtonQueue",{create:function(a){this.container=a.container;this.pageContainer=a.pageContainer;this.extended=a.extended;this.edtNumber=a.edtNumber?a.edtNumber:{body:null,width:0,top:0,space:0};this.buttonWidth=a.buttonWidth;this.buttonTop=a.buttonTop;this.buttons=a.buttons.clone();this.buttonCount=this.buttons.length;this.buttons.each(function(b){b.freedom();b.hint=!0});this.pickButtons();this.bevels=a.bevels;for(a=0;a<this.bevels.length;a++)this.bevels[a].freedom()},pickButtons:function(){this.btnFirst=
...
this.btnForward=this.buttons.find("forward").get(0),this.buttons.remove(this.btnBackward),this.buttons.remove(this.btnForward),this.pageButtonCount=6);this.buttonCount=this.buttons.length},sort:virtual_function});
Class("PCButtonQueue",{sort:function(){var a=this.buttonWidth+16,b=Math.floor((this.container.width-10)/a);b=Number.between(b,0,this.buttonCount);a=(this.container.width-b*a)/2;b<this.buttonCount&&b--;for(var c=0;c<this.buttons.length;c++){var d=this.buttons.get(c);if(c<b){if(d==this.buttons.find("sound").get(0)&&bookConfig.BackgroundSoundURL&&(VolumeControlBar.config.direction=VolumeControlBar.BOTTOM,d.title=!1),"WeChatShareButton"==d.getClassName()&&global.WeChatShareImg.setDirection(TextBubble.BOTTOM),
"TelephoneNumberButton"==d.getClassName()&&global.PcTelephoneNumberFrame.setDirection(TextBubble.BOTTOM),d.addTo(this.container.body),d.setPosition(a,this.buttonTop),a+=this.buttonWidth,c<b-1||b<this.buttonCount)d=this.bevels[c],a+=8,d.addTo(this.container.body),d.setPosition(a,this.buttonTop),a+=8}else d==this.buttons.find("sound").get(0)&&bookConfig.BackgroundSoundURL&&(VolumeControlBar.config.direction=VolumeControlBar.DEFAULT,d.title=!1),"WeChatShareButton"==d.getClassName()&&global.WeChatShareImg.setDirection(TextBubble.DEFAULT),
"TelephoneNumberButton"==d.getClassName()&&global.PcTelephoneNumberFrame.setDirection(TextBubble.LEFT),d.addTo(this.extended),d.hint=!1}b<this.buttonCount&&(this.btnMore.addTo(this.container.body),this.btnMore.setPosition(a,this.buttonTop));this.addPageButtons()},addPageButtons:function(){function a(l){l.addTo(c);l.setPosition(d,f);d+=e}function b(){d+=k;g.css({left:d+"px",top:h+"px",width:m+"px",display:"block"});g.find("input").css({width:m+"px"});d+=m+4;d+=k}var c=this.pageContainer.body,d=Math.floor((this.pageContainer.width-
(this.edtNumber.width+2*this.edtNumber.space+this.pageButtonCount*this.buttonWidth))/2),e=this.buttonWidth,f=this.edtNumber.top,g=this.edtNumber.body,h=this.edtNumber.top,k=this.edtNumber.space,m=this.edtNumber.width;rightToLeft?(bookConfig.enablePageBack&&a(this.btnForward),a(this.btnLast),a(this.btnNext),b(),a(this.btnPrevious),a(this.btnFirst),bookConfig.enablePageBack&&a(this.btnBackward)):(bookConfig.enablePageBack&&a(this.btnBackward),a(this.btnFirst),a(this.btnPrevious),b(),a(this.btnNext),
a(this.btnLast),bookConfig.enablePageBack&&a(this.btnForward));return d}}).extend("ButtonQueue");Class("MobileButtonQueue",{sort:function(a,b){a=this.edtNumber.width+2*this.edtNumber.space+4*this.buttonWidth;this.addPageButtons(a,(this.container.width-a)/2);this.buttons.each(function(c){c.addTo(this.extended)}.bind(this))}}).extend("ButtonQueue");Class("PCToolbar",{initBar:function(){this.topBar=$("<div class='fbTopBar' id='fbTopBar'></div>");this.bottomBar=$("<div class='fbToolBar' id='fbToolBar'></div>");this.logoBar=$("<div id='logoBar' class='logoBar'></div>");this.buttonTopBar=$("<div class='top right buttonTopBar'></div>");this.buttonBar=$("<div class='bottom left buttonBar'></div>");this.edtPageNumber=$("<div class='pageNumber' id='tfPageIndex'><label><input aria-labelledby='currentPageIndex' type='text' id='currentPageIndexTextField' autocomplete='off' size='13'/></label></div>");
this.parent.append(this.topBar);this.parent.append(this.bottomBar);this.topBar.append(this.buttonTopBar);this.topBar.append(this.logoBar);this.bottomBar.append(this.buttonBar);this.buttonBar.append(this.edtPageNumber);var a=this.color.toString();this.topBar.addBorderShadow(a,0,2);this.bottomBar.addBorderShadow(a,0,-2);this.topBar.css({background:this.color.rgba(this.topBarAlpha)});this.bottomBar.css({background:this.color.rgba(this.bottomBarAlpha)});this.topBar.css({"border-bottom":"1px solid "+this.color.add(40)});
this.bottomBar.css({"border-top":"1px solid "+this.color.add(40)});this.topBarAlpha||this.topBar.css({"box-shadow":"none","-webkit-box-shadow":"none",border:"none"});this.bottomBarAlpha||this.bottomBar.css({"box-shadow":"none","-webkit-box-shadow":"none",border:"none"});VolumeControlBar.config={color:this.color.toString(),iconColor:Color(bookConfig.iconColor).toString(),direction:VolumeControlBar.BOTTOM};this.initBevels();this.initPageNumber()},resetToolbarColor:function(){this._super();this.topBarAlpha=
Math.min(bookConfig.topToolBarAlpha,bookConfig.ToolBarAlpha);this.bottomBarAlpha=Math.min(bookConfig.bottomToolBarAlpha,bookConfig.ToolBarAlpha);var a=this.color.toString();this.topBar.addBorderShadow(a,0,2);this.bottomBar.addBorderShadow(a,0,-2);this.topBar.css({background:this.color.rgba(this.topBarAlpha)});this.bottomBar.css({background:this.color.rgba(this.topBarAlpha)});this.topBar.css({"border-bottom":"1px solid "+this.color.add(40)});this.bottomBar.css({"border-top":"1px solid "+this.color.add(40)});
this.topBarAlpha||(this.topBar.css({"border-bottom":"none"}),this.topBar.addBorderShadow("transparent",0,2));this.bottomBarAlpha||(this.bottomBar.css({"border-top":"none"}),this.bottomBar.addBorderShadow("transparent",0,2))},initBevels:function(){this.bevels=[];for(var a=0;a<this.buttons.length;a++)this.bevels.push(new ButtonBevel(this.color))},initPageNumber:function(){var a=this.edtPageNumber.find("input");a.css({color:Color(bookConfig.pageNumColor).toString()});var b=parseInt(bookConfig.totalPageCount),
c=16;""==bookConfig.pageNumberCaption&&(1E4<=b&&(c=16),1E4>b&&(c=10),1E3>b&&(c=7),100>b&&(c=4),10>b&&(c=3));a.attr("size",c);this.edtPageWidth=this.edtPageNumber.width()},setButtonTitle:function(a){if("WeChatShareButton"==a.getClassName())global.WeChatShareImg=new WeChatShare({parent:this.parent,color:"#fff",textColor:bookConfig.toolbarColor,margin:10,padding:10,arrowHeight:12,arrowWidth:12});else if("TelephoneNumberButton"==a.getClassName())global.PcTelephoneNumberFrame=new PcTelephoneNumberBubble({parent:this.parent,
color:this.color,textColor:a.fontColor,margin:12,padding:15,arrowHeight:8,arrowWidth:8});else{var b=new SolidArrowTextBubble({parent:this.parent,text:a.caption,color:this.color,textColor:a.fontColor,margin:13});a.setTitle(b)}},initExtendedbar:function(){this.extendedBar=new PCExtendedBar(this.parent);global.moreBar=this.extendedBar},addTopRightButton:function(){this.topRightButton||(this.topRightButton=$("<div class='topRightButton' id='createButton'></div>"),bookConfig.ToolBarVisible?(this.topBar.append(this.topRightButton),
this.onResize()):this.parent.append(this.topRightButton))},removeTopRightButton:function(){this.topRightButton&&(this.topRightButton.remove(),this.topRightButton=null)},getTopRightButtonWidth:function(){return this.topRightButton&&this.topRightButton.width()+10||0},onResize:function(a,b){if(bookConfig.ToolBarVisible){void 0==a&&(a=this.parent.width());void 0==b&&this.parent.height();b=this.logoBar.width()+20;var c=this.getTopRightButtonWidth();this.buttonBarWidth=a-2*b-c;this.buttonTopBar.css({left:b+
"px",width:this.buttonBarWidth+"px"});this.numberBarWidth=a;this.resetButtonPosition()}},resetButtonPosition:function(){(new PCButtonQueue({buttons:this.buttons,bevels:this.bevels,buttonWidth:30,buttonTop:8,container:{body:this.buttonTopBar,width:this.buttonBarWidth},pageContainer:{body:this.buttonBar,width:this.numberBarWidth},extended:this.extendedBar.$bar,edtNumber:{body:this.edtPageNumber,width:this.edtPageWidth,top:6,space:5}})).sort();this.extendedBar.resize(this.buttonsInExtendedBar());this.extendedBar.hide();
this.buttons.each(function(a){a.changeColor();a.$button.asButton().mouseEnterLight("rgba(255,255,255,0.2)")}.bind(this))}}).extend("Toolbar");
